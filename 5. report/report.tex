...
\begin{figure}[H]
    \centering
    \includegraphics[width=.85\linewidth]{roc_curves/Zero Experiment.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=.85\linewidth]{roc_curves/First Experiment.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=.85\linewidth]{roc_curves/Second Experiment.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=.85\linewidth]{roc_curves/Third Experiment.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=.85\linewidth]{roc_curves/Fourth Experiment.png}
